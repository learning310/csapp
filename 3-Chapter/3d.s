...
00000000004003e0 <_start>:
  ...
  4003fd:	48 c7 c7 12 05 40 00 	mov    $0x400512,%rdi
...
00000000004004d6 <test>:
  4004d6:	48 8d 04 fd 00 00 00 	lea    0x0(,%rdi,8),%rax
  4004dd:	00 
  4004de:	48 85 f6             	test   %rsi,%rsi
  4004e1:	7e 13                	jle    4004f6 <test+0x20>
  4004e3:	48 39 f7             	cmp    %rsi,%rdi
  4004e6:	7d 07                	jge    4004ef <test+0x19>
  4004e8:	48 89 f0             	mov    %rsi,%rax
  4004eb:	48 29 f8             	sub    %rdi,%rax
  4004ee:	c3                   	retq   
  4004ef:	48 89 f8             	mov    %rdi,%rax
  4004f2:	48 21 f0             	and    %rsi,%rax
  4004f5:	c3                   	retq   
  4004f6:	48 83 fe ff          	cmp    $0xffffffffffffffff,%rsi
  4004fa:	7d 04                	jge    400500 <test+0x2a>
  4004fc:	48 8d 04 37          	lea    (%rdi,%rsi,1),%rax
  400500:	f3 c3                	repz retq 

0000000000400502 <arith>:
  400502:	48 8d 47 07          	lea    0x7(%rdi),%rax
  400506:	48 85 ff             	test   %rdi,%rdi
  400509:	48 0f 49 c7          	cmovns %rdi,%rax
